...
# jan 14 code corrected commented above code this day and commented this code on jan 27 for not opening the whatsapp window so i  have used the above code
